#!/bin/bash
# HomeRun Clone - Device Detection and Scanner Setup
# Run this script on your Raspberry Pi to detect devices and set up the scanner

echo "============================================================"
echo "HomeRun Clone - Device Detection & Scanner Setup"
echo "============================================================"
...
echo "USB Devices:"
lsusb | grep -i hauppauge || echo "  No Hauppauge devices found in USB list"
...
echo ""
echo "Kernel modules:"
lsmod | grep -E "(em28xx|lgdt|si2157)" || echo "  No relevant modules loaded"

echo ""
echo "============================================================"
echo "Setting up Enhanced Channel Scanner"
echo "============================================================"

# Create the channel scanner if it doesn't exist
if [ ! -f "/opt/homerun-clone/channel_scanner.py" ]; then
    echo "Creating enhanced channel scanner..."
    
cat > /opt/homerun-clone/channel_scanner.py << 'EOF'
#!/usr/bin/env python3
"""
...
EOF
    ...
    echo "✓ Enhanced channel scanner created"
else
    echo "✓ Channel scanner already exists"
fi

echo ""
echo "============================================================"
echo "Testing Channel Scanner"
echo "============================================================"

# Test the scanner
cd /opt/homerun-clone
if [ -f "./venv/bin/python" ]; then
    echo "Testing scanner with virtual environment..."
    ./venv/bin/python channel_scanner.py --help
else
    echo "Testing scanner with system Python..."
    python3 channel_scanner.py --help
fi
...
echo "============================================================"
echo ""
echo "Quick scan (recommended first):"
echo "  ./venv/bin/python channel_scanner.py --quick"
echo ""
echo "Full scan (all channels):"
echo "  ./venv/bin/python channel_scanner.py --threshold 15"
echo ""
echo "Custom scan:"
echo "  ./venv/bin/python channel_scanner.py --start 7 --end 13 --threshold 25"
echo ""
